...
HD_PWD='C:/Xilinx/Vivado/2018.2/final_merge_v1/final_merge_v1.runs/system_memory_ctrl_merge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_memory_ctrl_merge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_memory_ctrl_merge_0_0.tcl
